...
function ShareButtons({ result }: ShareButtonsProps) {
  ...
  const handleTwitterShare = () => {
    const text = `나는 ${subtitle} ${type}! 당신의 MBTI는? #MBTI테스트 #Buzzit`
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 max-w-2xl mx-auto">
      <h3 className="text-lg font-bold text-gray-900 mb-4 text-center">결과 공유하기</h3>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        >
          ...
          <span className="text-sm font-semibold text-gray-900">카카오톡</span>
        </button>
        ...
        >
          ...
          <span className="text-sm font-semibold text-white">트위터</span>
        </button>
        ...
        >
          ...
          <span className="text-sm font-semibold text-white">페이스북</span>
        </button>
